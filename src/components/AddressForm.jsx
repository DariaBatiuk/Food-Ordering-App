...
import { setAddress } from "../pages/userInfo/addressSlice";
    ...
    >
      ...
      <div className="mb-4">
        <label
          ...
          htmlFor="streetAddress" // corrected attribute name
        >
          Street Address
        </label>
        <input
        ...
        />
				...
				<div className="mb-4 md:mr-2 md:mb-0 flex-1">
					<label className="block mb-2 text-sm font-bold text-gray-700" htmlFor="province">
						Province
					</label>
					<input
          {...register('province')}
        ...
        />
				...
				<div className="mb-4 md:mr-2 md:mb-0 flex-1">
					<label className="block mb-2 text-sm font-bold text-gray-700" htmlFor="postalCode">
						Postal Code
					</label>
					<input
          {...register('postalCode')}
